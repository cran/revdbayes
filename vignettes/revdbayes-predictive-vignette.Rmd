...
The vignette
[Introducing revdbayes](revdbayes-vignette.html) covers the sampling from extreme value posterior distributions and the vignette [Faster simulation using revdbayes](revdbayes-using-rcpp-vignette.html) considers how to do this more quickly.
...
`portpirie` and `gom` datasets that feature in the vignette [Introducing revdbayes](revdbayes-vignette.html).
